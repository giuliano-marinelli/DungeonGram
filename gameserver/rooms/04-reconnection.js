...
var ReconnectionRoom = /** @class */ (function (_super) {
    __extends(ReconnectionRoom, _super);
    function ReconnectionRoom() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ReconnectionRoom.prototype.onCreate = function (options) {
    };
    ReconnectionRoom.prototype.onJoin = function (client, options, auth) {
        client.send("status", "Welcome!");
    };
    ReconnectionRoom.prototype.onLeave = function (client, consented) {
    ...
    ReconnectionRoom.prototype.onDispose = function () {
    };
    return ReconnectionRoom;
}(colyseus_1.Room));
